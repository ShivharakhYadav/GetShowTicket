...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white">
      <section className="border-t border-gray-700 px-4">
        <div className="mx-auto grid w-full max-w-screen-xl gap-8 py-20 lg:grid-cols-5">
          <div className="sm:col-span-3 lg:col-span-2">
            ...
            <p className="max-w-sm text-sm">
              ...
              purchasing tickets for the latest concerts, theater productions,
              and live events. Experience seamless ticket booking with
              user-friendly features and secure transactions.
            </p>
          </div>
